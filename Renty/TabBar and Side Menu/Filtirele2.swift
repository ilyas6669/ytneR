...
//  Renty
//
//  Created by İlyas Abiyev on 4/9/20.
...
class Filtrele2: UIViewController,UIPickerViewDelegate,UIPickerViewDataSource  {
    
    
    
   let kategoriler = ["Kamp Malzemeleri","Kutu Oyunları","Elektronik Eşyalar","Spor Ekipmanı","Tamir Aletleri","Kıyafet","Enstrüman","Diğer","Açık Kütüphane"]
    ...
    let urunField4 : UITextField = {
           
           let cityField = UITextField()
           cityField.attributedPlaceholder = NSAttributedString(string: "Hangi Kategori?", attributes: [NSAttributedString.Key.foregroundColor: UIColor.gray])
           cityField.textColor = .black
           cityField.textAlignment = .center
           cityField.backgroundColor = .white
           cityField.layer.cornerRadius = 10
    ...
    var itemcategory = "kampmalzemeleri"
    ...
    override func viewDidLoad() {
        ...
        urunField4.inputView = pickerView4
        ...
        let urunfieldSV = UIStackView(arrangedSubviews: [urunField4,urunField,urunField2,urunField3])
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        search.minprice = "\(seekSlider.selectedMinValue)"
        search.maxprice = "\(seekSlider.selectedMaxValue)"
        
        
        if firstdate == ""{
            firstdate = "none"
        }
        search.firstdate = firstdate
        ...
        search.filtrelekeyword = "hasfilter"
    ...
    func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        ...
        if pickerView4.tag == 4 {
            urunField4.text = kategoriler[row]
            urunField4.resignFirstResponder()
        }
        else if pickerView.tag == 1{ //category 2
