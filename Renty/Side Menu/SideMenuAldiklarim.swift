...
class SideMenuAldiklarim: UIViewController, UIGestureRecognizerDelegate {
...
//
    ...
    func layoutDuzenle() {
        let logo = UIImage(named: "Aldiklarim-1")
...
extension SideMenuAldiklarim : UICollectionViewDataSource,UICollectionViewDelegateFlowLayout {
